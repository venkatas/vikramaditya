...
- Tested on: app.clientj.com (Vite) — found 226 live endpoints from 52 JS files
...
- Tested on: app.clientj.com — auto-detected v1/auth/login
...
- Tested on: app.clientj.com — correctly detected same-origin API
