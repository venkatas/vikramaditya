...
def _sqlmap_dump_failed(out: str) -> bool:
    ...
    errors — covering BOTH tamper-induced failure modes observed on ttdtcp:
...
def _sqlmap_targeted_extract(req_abs: str, sqli_dir: str, schema: str, table: str,
    ...
    on ttdtcp.ap.gov.in where a full --dump returned nothing but this recovered the
...
def run_sqlmap_request_file(req_file: str, domain: str | None = None,
    ...
    # UNION reflection — ttdtcp's GetSearch autocomplete), fall back to fetching
