...
**v5.4 — credential store + /pickup session resume + CI/CD workflow scanner + HackerOne MCP + CVSS 4.0 scoring + fully autonomous VAPT + HAR-based authenticated testing**
