...
A/B comparison run on 03 May 2026 (projx.clientb.com, same args, parallel) confirmed `phi4:14b` strictly dominates `gemma4:26b` on output utility:
...
| **P19** | SPA-catchall false-positive suppression in exposure module | 87 false positives across two engagements (projx + mtrack patterns) | XS |
